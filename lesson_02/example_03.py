...
if age < 30 and 50 < mass < 120:
    print(name,",",age," год,", "вес ",mass," - хорошее состояние")
elif (30 < age < 40) and (mass < 50 or mass > 120):
    print(name,",",age," год,", "вес ",mass," - следует заняться собой")
elif age > 40 and (mass < 50 or mass > 120):
    print(name,",",age," год,", "вес ",mass," - следует обратится к врачу!")
else:
    print('Мои полномочия тут всё')